    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-4 sm:p-6 md:p-8">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mb-8 sm:mb-12 text-center">
          <h1 className="mb-3 sm:mb-4 text-3xl sm:text-4xl md:text-5xl font-bold text-slate-900">
            UI Kit - Radix UI
          </h1>
          <p className="text-base sm:text-lg md:text-xl text-slate-600 px-4">
            ...
            <a
              ...
              className="flex items-center gap-2 rounded-lg bg-slate-900 px-4 sm:px-6 py-2.5 sm:py-3 text-sm sm:text-base font-medium text-white hover:bg-slate-800"
            >
            ...
            <a
              href="/demo"
              className="flex items-center gap-2 rounded-lg border border-slate-300 bg-white px-4 sm:px-6 py-2.5 sm:py-3 text-sm sm:text-base font-medium text-slate-900 hover:bg-slate-50"
            >
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden="true">
        ...
        {/* Installation */}
        <div className="mb-8 sm:mb-12 rounded-lg bg-white p-4 sm:p-6 md:p-8 shadow-lg">
          <h2 className="mb-3 sm:mb-4 text-xl sm:text-2xl font-bold text-slate-900">
            Quick Start
          </h2>
          <div className="space-y-4">
            <div>
              ...
              <code className="block overflow-x-auto rounded-md bg-slate-900 p-3 sm:p-4 text-xs sm:text-sm text-white">
...
function FeatureCard({ title, description }: { title: string; description: string }) {
  return (
    <div className="rounded-lg border border-slate-200 bg-white p-4 sm:p-6">
      <h3 className="mb-2 text-base sm:text-lg font-semibold text-slate-900">{title}</h3>
